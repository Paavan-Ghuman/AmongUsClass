...
class Map{
	...
	/**
	 * This static factory method initializes to the value of parameter map
	 * @param map is used to initialize a new map
	 * @return Returns an object of map.  
	 */
